...
signed main(void) {fast
	...
	int d1 = pow(ABC[0].first - ABC[1].first, 2) + pow(ABC[0].second - ABC[1].second, 2);
	int d2 = pow(ABC[1].first - ABC[2].first, 2) + pow(ABC[1].second - ABC[2].second, 2);
	int d3 = pow(ABC[2].first - ABC[0].first, 2) + pow(ABC[2].second - ABC[0].second, 2);

	yn(d1 == d2 + d3 || d2 == d3 + d1 || d3 == d1 + d2);
